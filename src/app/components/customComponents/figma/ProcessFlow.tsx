...
const ProcessCard = ({ 
  ...
  return (
    <div 
      className={`
        w-[70px] sm:w-[80px] md:w-[100px] cursor-pointer
        ${isMobile ? 'relative mx-2' : 'absolute'}
        ${className}
      `}
      style={isMobile ? {} : {
        ...position,
    ...
    >
      <Card className={`
        bg-black rounded-xl overflow-hidden transform transition-all duration-300 
      ...
      `}>
        <CardContent className="p-0">
          ...
          <div className="p-2 text-center">
            <h3 className="font-semibold text-[10px] md:text-sm text-white line-clamp-2">
              {title}
            </h3>
          </div>
        </CardContent>
      ...
      <div className="grid md:grid-cols-2 gap-4">
        ...
        <div className="md:order-1 space-y-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            <Button className="w-full sm:w-auto bg-emerald-600 hover:bg-emerald-700 text-sm sm:text-base">
              Schedule Consultation
            </Button>
    ...
    <div className="relative w-full min-h-screen bg-black">
      ...
      <div className="relative z-10 container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-xs sm:text-sm md:text-base text-blue-200 max-w-2xl mx-auto">
            Comprehensive Linux and cloud computing education for the modern tech landscape
          </p>
        </div>
        ...
        <div className="relative max-w-5xl mx-auto mb-8">
          {/* Mobile Layout */}
          <div className="md:hidden">
            <div className="flex justify-center gap-4 mb-8 overflow-x-auto pb-4 px-4">
              {sortedCards.map((card, index) => (
                <ProcessCard
                  key={index}
                  {...card}
        ...
        {/* Center Details Card */}
        <div className="relative max-w-4xl mx-auto mt-8 md:mt-10">
          <CenterDetailsCard details={sortedCards[activeCardIndex].centerDetails} />
        </div>
      </div>
    </div>
