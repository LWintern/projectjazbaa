              ...
              <div className="md:w-2/3 overflow-hidden h-[440px]"> {/* Increased height */}
                <div className="flex animate-carousel items-center h-full"> {/* Added h-full */}
                  {duplicatedImages.map((image, index) => (
                    <div
                      key={`image-${index}`}
                      className={`relative w-[120px] flex-shrink-0 h-[400px] md:w-[140px] md:h-[300px] overflow-hidden rounded-[100px] mx-2 cursor-pointer transition-transform hover:scale-105 
